...
import com.scrim_helper.models.Stats;
...
public class ExcelExporter {
    ...
    public static void exportToExcel(List<FinalDetails> matchesDetails, String filePath) {
        ...
        for (FinalDetails match : matchesDetails) {
            ...
            row.createCell(++rowIndex).setCellValue(match.getHero().toString());
            row.createCell(++rowIndex).setCellValue(match.getPlayer().getPlayerName());
